class Cuento{
  ...
  /*get img(){
    ...
    picture.src = '../../assets/img/' + this._img + '.jpg';
...
cuentos.push(new Cuento({
  img: 'tortuga',
  name: 'Tortuga Tomasa',
  content: "Un día de sol la tortuga Tomasa se fue al se columpió y luego se cayó del columpio. Vino su" +
...
cuentos.push(new Cuento({
  ...
  content: "Erase una vez un ratón que iba caminando y se encontró con una rana, El ratón luego se fue al río " +
...
cuentos.push(new Cuento({
  ...
  content:  "Erase una vez un huevo que andaba por la carretera. Cuando el semáforo se puso verde se fue a la " +
...
cuentos.push(new Cuento({
  ...
  content:  "Una mariquito que se llamaba Quica fue a posear al bosque. En el bosque habia un periquito y un " +
...
cuentos.push(new Cuento({
  ...
  content: "Había una vez una pata que se llamaba Pepa Pepa vivía en el agua del parque, Jugaba con una " +
